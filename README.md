...
ros2 pkg create nav2_rrtstar_planner --dependencies pluginlib nav2_core --license Apache-2.0
ros2 pkg create nav2_frrtstar_planner --dependencies pluginlib nav2_core --license Apache-2.0
# checking errors
