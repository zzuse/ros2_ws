...
void setup()
{
    ...
    /* calibrated: rotation test under-reported
        ...
        // new wheel_distance = 168.7 × 1.00758 ≈ 170.0 mm. Expect ~±1.8°/turn, equal and
        // opposite — that is the mechanical asymmetry floor; STOP iterating this param there.
    */
    const float wheel_distance_mm = 170.0;
